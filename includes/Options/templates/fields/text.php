...
<tr valign="top">
    ...
    <td>
        <input name="<?php echo esc_attr($option->getNameAttribute()); ?>" id="<?php echo $option->getIdAttribute(); ?>" type="text" value="<?php echo $option->getValueAttribute(); ?>" placeholder="<?php echo $option->getPlaceholderAttribute() ?: ''; ?>" class="regular-text">
