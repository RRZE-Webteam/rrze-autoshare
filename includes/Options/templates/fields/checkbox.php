...
<tr valign="top">
    ...
    <td class="rrze-wp-form rrze-wp-form-input">
        <label>
            <input name="<?php echo esc_attr($option->getNameAttribute()); ?>" id="<?php echo $option->getIdAttribute(); ?>" type="checkbox" value="<?php echo $option->getValueAttribute(); ?>" <?php echo $option->isChecked() ? 'checked' : null; ?> class="<?php echo $option->getInputClassAttribute(); ?>">
