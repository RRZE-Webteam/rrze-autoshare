...
```php
use RRZE\Autoshare\Settings\Settings;
...
```php
apply_filters('rrze_wp_settings_new_option_{$optionName}', mixed $value, object \RRZE\Autoshare\Settings\Options\Type)
```
