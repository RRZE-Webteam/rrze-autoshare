...
class Post
{
    public static function init()
    {
        ...
        add_action('rrze_autoshare_mastodon_publish_post_directly', [__CLASS__, 'publishPostDirectly']);
    ...
    {
        $postId = apply_filters('rrze_autoshare_mastodon_publish_post_directly', 0);
        ...
        wp_schedule_single_event(time(), 'rrze_autoshare_mastodon_publish_post_directly', [$postId]);
    }
