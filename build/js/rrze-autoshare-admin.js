(() => {
  ...
  (function registerAutosharePanel(wordpress) {
    ...
    function AutoshareSettingsPanel() {
      ...
      var isBlueskyDisabled = !autoshareObject.blueskyConnected || autoshareObject.blueskyPublished;
      var isMastodonDisabled = !autoshareObject.mastodonConnected || autoshareObject.mastodonPublished;
      var useState = wordpress.element.useState;
      var blueskyState = useState(
        autoshareObject.blueskyConnected && autoshareObject.blueskyEnabled && !autoshareObject.blueskyPublished
      );
      var mastodonState = useState(
        autoshareObject.mastodonConnected && autoshareObject.mastodonEnabled && !autoshareObject.mastodonPublished
      );
